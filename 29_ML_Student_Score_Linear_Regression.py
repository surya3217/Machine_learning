...
Where 
    ...
    f is the mapping function (model)
...
Mathematically
If we plot the values on a graph paper, 
...
# If Sandeep studied for 10 hours then 
# what would be his score
...
features = dataset.iloc[:, :-1]   ## 2 dim. dataframe 
print(type(features))
...
print (regressor.coef_*10 + regressor.intercept_) # [90.46590392]


# This can also be predicted using a function 
print (regressor.predict([[10]])) # [90.46590392]
...
# Now if I want to get 100 hours 
