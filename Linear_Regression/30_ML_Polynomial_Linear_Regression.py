...
dataset = pd.read_csv('All CSV/Claims_Paid.csv')
dataset.ndim
dataset.shape
...
# Label encoding should be there before One Hot encoding
# One Hot Encoding 
from sklearn.preprocessing import OneHotEncoder
onehotencoder = OneHotEncoder(categorical_features = [0])
features = onehotencoder.fit_transform(features).toarray()  ## toarray is very important
print(features)
...
# has come in the decision making process
